...
export class BarChartComponent implements OnChanges, OnInit {
  ...
  dailySO_waitT(){
    this.networkService.getSO_waitT(this.datefromdash).subscribe(
      output =>{
  ...
  dailyIW_waitT(){
    this.networkService.getIW_waitT(this.datefromdash).subscribe(
      output =>{
  ...
  dailyDIESEL_waitT(){
    this.networkService.getDIESEL_waitT(this.datefromdash).subscribe(
      output =>{
  ...
  dailyGASOHOL95_waitT(){
    this.networkService.getGASOHOL95_waitT(this.datefromdash).subscribe(
      output =>{
  ...
  dailyOW_waitT(){
    this.networkService.getOW_waitT(this.datefromdash).subscribe(
      output =>{
