...
@Component({
  selector: 'app-bar-chart4',
  templateUrl: './bar-chart4.component.html',
  styleUrls: ['./bar-chart4.component.css']
})
export class BarChart4Component implements OnInit {
  ...
  dailySO_numq(){
    this.networkService.getmoSO_Numq().subscribe(
      output =>{
  ...
  dailyIW_numq(){
    this.networkService.getmoIW_Numq().subscribe(
      output =>{
  ...
  dailyDIESEL_numq(){
    this.networkService.getmoDIESEL_Numq().subscribe(
      output =>{
  ...
  dailyGASOHOL95_numq(){
    this.networkService.getmoGASOHOL95_Numq().subscribe(
      output =>{
  ...
  dailyOW_numq(){
    this.networkService.getmoOW_Numq().subscribe(
      output =>{
